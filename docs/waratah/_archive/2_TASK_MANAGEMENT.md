<!-- ARCHIVED 2026-05-17 (Phase 4 of Waratah docs consolidation). Content fully migrated: manager to /docs/waratah/for-managers/02-task-management.md and /04-staff-and-recipients.md (Phase 2); admin to /docs/waratah/for-admins/01-configuration-reference.md and /02-staff-and-access-management.md (Phase 3); developer audit trail internals to /docs/waratah/for-developers/06-task-management-internals.md (Phase 4). This file is preserved for historical reference. Do not edit. -->

> 🗄️ **Archived (2026-05-17).** All content moved across the 4-phase consolidation. Canonical references: manager → `for-managers/02-task-management.md` and `/04-staff-and-recipients.md`; admin → `for-admins/01-configuration-reference.md` and `/02-staff-and-access-management.md`; developer → `for-developers/06-task-management-internals.md`.
