<!-- PARTIALLY SUPERSEDED 2026-05-17 (Phase 2 of Waratah docs consolidation). Manager-tier content has been canonicalised to /docs/waratah/for-managers/03-weekly-automation.md. Admin content (trigger recreation procedures) remains here pending Phase 3. Developer content (trigger destruction patterns) remains here pending Phase 4. See /docs/plans/2026-05-17-waratah-docs-consolidation-design.md. -->

> ⚠️ **Partially Superseded (2026-05-17).** Manager-tier content has moved to [`/docs/waratah/for-managers/03-weekly-automation.md`](../../docs/waratah/for-managers/03-weekly-automation.md). Admin and developer content remains here until Phases 3 and 4 of the [documentation consolidation](../../docs/plans/2026-05-17-waratah-docs-consolidation-design.md) complete.
