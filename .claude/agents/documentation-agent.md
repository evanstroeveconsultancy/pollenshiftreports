...
- `THE WARATAH/FILE EXPLAINERS/2_TASK_MANAGEMENT.md`, `THE WARATAH/FILE EXPLAINERS/3_WEEKLY_AUTOMATED_EVENTS.md`, `THE WARATAH/FILE EXPLAINERS/4_TROUBLESHOOTING.md`, `THE WARATAH/FILE EXPLAINERS/5_CONFIGURATION_REFERENCE.md` <!-- 2026-05-17: 1_DAILY_SHIFT_REPORT archived; superseded by docs/waratah/for-daily-users/shift-report-walkthrough.md -->
- `docs/waratah/README.md`, `docs/waratah/for-daily-users/shift-report-walkthrough.md` <!-- Added 2026-05-17 Phase 1 of docs consolidation; canonical Daily User home -->
- `THE WARATAH/FILE EXPLAINERS/README.md` <!-- Added 2026-05-17 Phase 1: stub README documenting consolidation status of FILE EXPLAINERS directory -->
- `docs/waratah/explainers/02-INTERMEDIATE-How-The-System-Works.md`, `docs/waratah/explainers/03-ADVANCED-Complete-Backend-Reference.md` <!-- 2026-05-17 Phase 1: 01-BASIC archived; remaining 02-INTERMEDIATE and 03-ADVANCED stay until Phase 2 and Phase 4 respectively. Treat as required-check files for any sheet structure, named range, cell layout, warehouse schema, or trigger schedule changes -->
...
- `THE WARATAH/FILE EXPLAINERS/` — 4 remaining manager-facing handover docs (2_TASK_MANAGEMENT, 3_WEEKLY_AUTOMATED_EVENTS, 4_TROUBLESHOOTING, 5_CONFIGURATION_REFERENCE) + transitional README.md. 1_DAILY_SHIFT_REPORT archived 2026-05-17, superseded by `docs/waratah/for-daily-users/shift-report-walkthrough.md`. Files 2-5 will consolidate into `docs/waratah/for-managers/` (Phase 2) and `docs/waratah/for-admins/` (Phase 3).
- `docs/waratah/` (new audience-tiered hierarchy, in progress since 2026-05-17) — `README.md` (root router), `for-daily-users/` (Phase 1 complete), `for-managers/` (Phase 2 pending), `for-admins/` (Phase 3 pending), `for-developers/` (Phase 4 pending), `_archive/` (preserved legacy files). Full plan: `/docs/plans/2026-05-17-waratah-docs-consolidation-design.md`.
- `docs/waratah/explainers/` — 2 remaining manager-facing tiers (02-INTERMEDIATE-How-The-System-Works, 03-ADVANCED-Complete-Backend-Reference). 01-BASIC archived 2026-05-17, superseded by `docs/waratah/for-daily-users/shift-report-walkthrough.md`. UPDATE WHEN: sheet structure, named ranges, cell layouts, cash recon, warehouse schema, trigger schedule, or system cutover occurs. These remaining explainers are required-check files until their consolidation phases complete (02 → Phase 2, 03 → Phase 4).
