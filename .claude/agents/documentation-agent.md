...
- `docs/waratah/for-developers/README.md`, `docs/waratah/for-developers/01-architecture-and-data-flow.md`, `docs/waratah/for-developers/02-cell-reference-and-field-config.md`, `docs/waratah/for-developers/03-integration-pipeline.md`, `docs/waratah/for-developers/04-warehouse-schemas.md`, `docs/waratah/for-developers/05-rollover-and-triggers.md`, `docs/waratah/for-developers/06-task-management-internals.md` <!-- 2026-05-17 Phase 4: canonical Developer tier home (7 files); 12 legacy Waratah docs archived to docs/waratah/_archive/ -->
- `THE WARATAH/FILE EXPLAINERS/README.md` <!-- 2026-05-17 Phases 1-4: redirect README; all 5 numbered legacy files now archived -->
...
- `THE WARATAH/FILE EXPLAINERS/` — only `README.md` remains (redirect stub). All 5 numbered legacy files archived: 1_DAILY (Phase 1), 5_CONFIGURATION_REFERENCE (Phase 3), and 2_TASK_MANAGEMENT, 3_WEEKLY_AUTOMATED_EVENTS, 4_TROUBLESHOOTING (Phase 4).
- `docs/waratah/` (audience-tiered hierarchy, **consolidation complete 2026-05-17**) — `README.md` (root router), `for-daily-users/` (1 file), `for-managers/` (6 files), `for-admins/` (5 files), `for-developers/` (7 files), `_archive/` (12 preserved legacy files). Full plan: `/docs/plans/2026-05-17-waratah-docs-consolidation-design.md`.
